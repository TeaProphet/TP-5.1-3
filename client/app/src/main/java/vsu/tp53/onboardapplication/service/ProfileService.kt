...
class ProfileService(
    ...
    private val getProfileUrl: String = "http://193.233.18.159/get_profile_info/{nickname}"
    private val editProfileUrl: String = "http://193.233.18.159/change_profile/{idToken}"
    private val increaseRepUrl: String = "http://193.233.18.159/plus_reputation/"
    private val decreaseRepUrl: String = "http://193.233.18.159/minus_reputation/"
    private val banUserUrl: String = "http://193.233.18.159/ban/"
    private val unbanUserUrl: String = "http://193.233.18.159/unban/"
        ...
        try {
            return withContext(Dispatchers.IO) {
                ...
                val profResp = restTemplate.getForObject(
                    "http://193.233.18.159/get_profile_info/$searchedLogin",
